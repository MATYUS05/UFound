    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.metaRow}>
          ...
          <Text style={styles.metaText}>{catEmoji} {item.category}</Text>
        ...
        <View style={styles.section}>
          ...
          {(item.status === 'claimed' || item.status === 'completed') && (
            <TouchableOpacity
              ...
              disabled={loading}>
              <Text style={styles.actionBtnText}>↩️ Kembalikan ke Tersedia</Text>
            </TouchableOpacity>
          )}
...
const styles = StyleSheet.create({
  ...
  locationText: { fontSize: 13, color: APP_COLORS.textMuted, marginBottom: 12 },
